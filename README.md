...
> `Python` — 크롤링 · 자동화 도구 · 토이 게임. 최근에는 `gitMonitor` 백엔드를 Python 으로 짰습니다.
...
![Spring Kafka](https://img.shields.io/badge/Spring_Kafka-231F20?style=flat-square&logo=apachekafka&logoColor=white)
...
![Hilt](https://img.shields.io/badge/Hilt-2C4AA8?style=flat-square)
![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white)

**프론트엔드 프레임워크** ![학습 중](https://img.shields.io/badge/%ED%95%99%EC%8A%B5%20%EC%A4%91-9E9E9E?style=flat-square)
...
- **Go** — Java 밖에서 서버를 처음부터 다시 세워 보는 중. 프로토콜 · 저장소 · 배포까지 직접 고릅니다.
- **프론트엔드** — 백엔드에서 화면까지 혼자 닫기 위해 React · Next.js 를 손에 익히는 중입니다.
- **데이터 파이프라인** — Kafka · Elasticsearch · Cassandra 를 인프라로 다뤄 왔고, 이제 그 위의 처리 · 모델링 쪽을 봅니다.
